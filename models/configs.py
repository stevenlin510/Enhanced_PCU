...
# model
parser.add_argument('--model', default='enhanced_pcu', help='model name: pugan, mpu, pugcn')
...
parser.add_argument('--base_lr_g', type=float, default=1e-4)
parser.add_argument('--beta', type=float, default=0.9)
parser.add_argument('--start_decay_step', type=int, default=40000)
